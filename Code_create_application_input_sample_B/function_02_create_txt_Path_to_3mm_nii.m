...
load(fullfile(Path_2_big_table, 'big_table_Barcelona_transgender_data.mat'));

fid = fopen('big_table_Barcelona_transgender_data.txt', 'wt');
...
for i = 1:size(big_table,1)
    old_Path_1mm = big_table.Path{i};
    new_Path_3mm = strrep(old_Path_1mm, 'cat12.5', 'cat12.5_3mm_resolution/data');
    big_table.Path(i) = {new_Path_3mm};
end
clear i old_Path_1mm new_Path_3mm

save(fullfile(savedir, 'big_table_Barcelona_transgender_data_3mm_paths'), 'big_table')
